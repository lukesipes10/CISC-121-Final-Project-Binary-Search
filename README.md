...
AI Disclaimer: Portions of the program code were written with assistance from Claude Opus 4.6 in accordance with the Level 4 AI policy mandated by the final project guidlines. Project concept, structure, and logic are entirely the author's own.
